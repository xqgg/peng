...
namespace CSharpTest
{
    public class DoubleLinkedTest
    {
        ...
        public void Swap()
        {
            ...
            DoubleLinked link_5 = new DoubleLinked();
            DoubleLinked link_6 = new DoubleLinked();

            link_1.InsertBefor(link_2);
            //12
            ...
            link_3.InsertAfter(link_2);
            link_4.InsertAfter(link_3);
            //1234

            link_1.Swap(link_4);
            //4231

            Assert.AreEqual(link_4.Next, link_2);
            Assert.AreEqual(link_4.Previous, null);
            Assert.AreEqual(link_2.Previous, link_4);

            Assert.AreEqual(link_1.Previous, link_3);
            Assert.AreEqual(link_1.Next, null);
            Assert.AreEqual(link_3.Next, link_1);

            link_5.InsertAfter(link_1);
            link_6.InsertAfter(link_5);
            //423156

            link_2.Swap(link_5);
            //453126

            Assert.AreEqual(link_5.Previous, link_4);
            Assert.AreEqual(link_4.Next, link_5);
            Assert.AreEqual(link_5.Next, link_3);
            Assert.AreEqual(link_3.Previous, link_5);

            Assert.AreEqual(link_2.Previous, link_1);
            Assert.AreEqual(link_1.Next, link_2);
            Assert.AreEqual(link_2.Next, link_6);
            Assert.AreEqual(link_6.Previous, link_2);

            link_4.Swap(link_1);
            //153426

            Assert.AreEqual(link_1.Next, link_5);
            Assert.AreEqual(link_1.Previous, null);
            Assert.AreEqual(link_5.Next, link_3);
            Assert.AreEqual(link_5.Previous, link_1);
            ...
            link_6.Swap(link_5);
            //163425
            Assert.AreEqual(link_1.Next, link_6);
            Assert.AreEqual(link_1.Previous, null);
            Assert.AreEqual(link_6.Next, link_3);
            Assert.AreEqual(link_6.Previous, link_1);
            Assert.AreEqual(link_3.Next, link_4);
            Assert.AreEqual(link_3.Previous, link_6);
            Assert.AreEqual(link_4.Next, link_2);
            Assert.AreEqual(link_4.Previous, link_3);
            Assert.AreEqual(link_2.Next, link_5);
            Assert.AreEqual(link_2.Previous, link_4);
